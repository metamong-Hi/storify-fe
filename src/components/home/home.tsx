    ...
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-[10%] left-[6%] z-1">
        <div className="mb-12 font-bold">
          ...
          <h1 className="text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mb-0 opacity-0 animate-fadeInUp delay-15s textWithShadow">
            동화 세계가 펼쳐집니다!
          </h1>
        </div>
        <div className="mb-6">
          <h2 className="text-gray-200 text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mb-3 opacity-0 animate-fadeInUp delay-2s textWithShadow">
            이야기를 흥미진진한 동화책으로
          </h2>
          <h2 className="text-gray-200 text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mb-3 opacity-0 animate-fadeInUp delay-25s textWithShadow">
            생생한 그림으로 살아나게 해줄 거예요
          </h2>
        </div>
        <button
          className="p-2 font-bold cursor-pointer hover:text-[#B68973] border rounded-xl border-[#B68973] opacity-0 bg-[#B68973] hover:bg-transparent text-white transition-all duration-300 ease-in-out transform hover:scale-150 animate-fadeInUp delay-3s text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl textWithShadow"
