    ...
    <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'top', width: '100vw', height: '100vh' }} className="bg-[#FAF3E0]/80">
      <div style={{ flex: 0.75, paddingTop : '10%', paddingLeft: '5%', textAlign: 'left' }}>
        <div style={{ fontSize: '3rem', marginBottom: '1.5rem' }}>
          <h1 style={{ opacity: 0 }}
          className="text-[#1E212D] animate-fadeInUp delay-1s">여러분의 평범한 일상을</h1>
          <h1 style={{ opacity: 0 }}
          className="text-[#EABF9F] animate-fadeInUp delay-15s">동화책으로 만들어 드려요</h1>
        </div>
        <div style={{ fontSize: '2.25rem', marginBottom: '1rem' }}>
          <h2 style={{ opacity: 0 }}
          className="text-[#1E212D] animate-fadeInUp delay-2s">저희에게 평범한 일상을 공유해 주세요</h2>
          <h2 style={{ opacity: 0 }}
          className="text-[#1E212D] animate-fadeInUp delay-25s">AI가 글과 그림을 만들어 줄 거에요</h2>
        </div>
        <button style={{ padding: '1rem', fontSize: '1.5rem', opacity: 0, cursor: 'pointer'}}
         className="text-[#B68973] animate-fadeInUp delay-3s"
