    ...
    <Link href="/writing/complex" passHref>
      ...
      >
        ...
        <div className="card-body items-center text-center">
          <h1 className="card-title text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:tet-5xl mb-0 sm:mb-0 md:mb-0.5 lg:mb-0.5 xl:mb-1 2xl:mb-1 text-base-content">요정과 쓸래요</h1>
          <h2 className="text-md md:text-lg lg:text-xl xl:text-2xl 2xl:tet-3xl text-base-content/80">글쓰기가 어렵다면</h2>
          <h2 className="text-md md:text-lg lg:text-xl xl:text-2xl 2xl:tet-3xl text-base-content/80">요정이 도와줄 거예요</h2>
        </div>
      </div>
    </Link>
  );
