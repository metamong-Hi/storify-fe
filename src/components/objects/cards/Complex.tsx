    ...
    <Link href="/writing/complex" passHref>
      ...
      >
        ...
        <div className="card-body items-center text-center">
          <h3 className="card-title text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:tet-5xl mb-0 sm:mb-0 md:mb-0.5 lg:mb-0.5 xl:mb-1 2xl:mb-1 text-base-content">요정과 쓸래요</h3>
