...
const SmallImageButton: React.FC<MediumImageButtonProps> = ({ onClick, imageSrc, alt }) => {
    return (
      <button 
        onClick={onClick} 
        className="
          inline-block relative
          p-1.5 border-2 border-purple-700 rounded-md
          sm:p-2 sm:border-3 sm:rounded-lg
